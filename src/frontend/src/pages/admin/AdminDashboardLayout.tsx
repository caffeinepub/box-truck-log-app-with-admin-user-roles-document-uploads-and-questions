...
import { useGetAllLogEntries, useGetAllUploads, useGetAllQuestions } from '../../hooks/useQueries';
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Manage all users' logs, documents, and questions</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-destructive">{openQuestions}</div>
          </CardContent>
        </Card>
      </div>
